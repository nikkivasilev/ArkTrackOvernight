...
export default function PolygonSvg({ width, height, points, onPointsChange, closed, onClose }) {
    ...
    const dragVertex = useCallback((idx, e) => {
        e.stopPropagation();
    ...
    const pathD = points.length === 0
        ...
        : points
            ...
            .join(" ") + (closed ? " Z" : "");
    return (_jsxs("svg", { ref: svgRef, viewBox: `0 0 ${width} ${height}`, preserveAspectRatio: "none", onClick: handleSvgClick, onDoubleClick: handleSvgDoubleClick, style: { cursor: closed ? "default" : "crosshair" }, children: [pathD && (_jsx("path", { d: pathD, fill: closed ? "rgba(78, 161, 255, 0.18)" : "none", stroke: "#4ea1ff", strokeWidth: 2, vectorEffect: "non-scaling-stroke" })), points.map(([x, y], i) => (_jsx("circle", { cx: x * width, cy: y * height, r: 6, fill: "#0f1115", stroke: "#4ea1ff", strokeWidth: 2, vectorEffect: "non-scaling-stroke", onPointerDown: (e) => dragVertex(i, e), style: { cursor: "grab" } }, i)))] }));
}
